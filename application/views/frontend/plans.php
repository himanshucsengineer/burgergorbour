                ...
                <div class="row ">
                            ...
                            <div class="col-md-4 px-4 py-2 mb-4">
                                <div class="fcard fcard_bg">
                                    ...
                                    <div class="fcard_content">
                                            ...
                                            <?php
                                                if (!isset($_SESSION["email"])) {
                                                    ...
                                                    echo '<form action="' . base_url() . 'register/pay" method="POST">
                                                        ...
                                                        <input type="" id="bal' . $i . '" name="vali" value="">
                                                        <input type="" id="acc' . $i . '" name="acc_type" value="">
                                                        <input type="" id="amtt' . $i . '" name="amount" value="">
                                        ...
                                        <hr>    
                                        <ul class="p-2">
                                            <li class="fcard_p fcard_li"><span><i class="far fa-check-square fcard_icon"></i></span>&nbsp; 2 year membership only at ₹ 1000</li>
                                            <li class="fcard_p fcard_li"><span><i class="far fa-check-square fcard_icon"></i></span>&nbsp; Get any 1 pizza free 1 time with two year membership</li>
                                            <li class="fcard_p fcard_li"><span><i class="far fa-check-square fcard_icon"></i></span>&nbsp; 2 year membership will cost you less than ₹ 600 after getting free pizza</li>
                                            <li class="fcard_p fcard_li"><span><i class="far fa-check-square fcard_icon"></i></span>&nbsp; salon package is included with this membership</li>
                                        </ul>
                                    </div>
                                </div>
                            </div><!-- end Fcard -->
                    ...
                    <div class="col-md-4 px-4 py-2 mb-4">
                        <div class="fcard fcard_bg">
                            <img src="<?php echo base_url() ?>assest/img/bg3.jpg" alt="" class="fcard_img">
                            <div class="fcard_content">
                                <h3 class="head_h3 mb-1">Chaap Course</h3>
                                <div class="row justify-content-center">
                                    <div class="col text-center">
                                        <p><sup class="amt_sec-sup">IN &#8377</sup> <span class="amt_sec-num" >499</span><sub class="amt_sec-sub"> / 1 year</sub></p>
                                        <p class="fcard_p">Take Your Offers and enjoy Your meal</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <select name=""  class="b_input amt_sec-select">
                                            <option >Buy Course: In 499 With validity : 1 year</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="text-center my-2">
                                    <?php
                                        if (!isset($_SESSION["email"])) {
                                            ...
                                            echo '<form action="' . base_url() . 'register/pay" method="POST">
                                                    <input type="" name="name" value="' . $_SESSION["name"] . '">
                                                    <input type="" name="email" value="' . $_SESSION["email"] . '">
                                                    <input type="" name="mob" value="' . $_SESSION["number"] . '">
                                                    <input type="" name="add" value="' . $_SESSION["add"] . '">
                                                    <input type="" name="pass" value="' . $_SESSION["pass"] . '">
                                                    <input type="" name="card" value="' . $_SESSION["card"] . '">
                                                    <input type="" name="image" value="' . $_SESSION["image"] . '">
                                                    <input type="" name="vali" value="12">
                                                    <input type="" name="acc_type" value="chaap">
                                                    <input type="" name="amount" value="499">
                                                    <button class="fcard_btn px-4">Buy Now</button>
                                                </form>';
                                        }
                                    ?>
                    ...
                    <div class="col-md-4 px-4 py-2 mb-4">
                        <div class="fcard fcard_bg">
                            <img src="<?php echo base_url() ?>assest/img/bg3.jpg" alt="" class="fcard_img">
                            <div class="fcard_content">
                                <h3 class="head_h3 mb-1">Pizza & Burger Course</h3>
                                <div class="row justify-content-center">
                                    <div class="col text-center">
                                        <p><sup class="amt_sec-sup">IN &#8377</sup> <span class="amt_sec-num" >499</span><sub class="amt_sec-sub"> / 1 year</sub></p>
                                        <p class="fcard_p">Take Your Offers and enjoy Your meal</p>
                                    ...
                                    <?php
                                        if (!isset($_SESSION["email"])) {
                                            ...
                                            echo '<form action="' . base_url() . 'register/pay" method="POST">
                                                    ...
                                                    <input type="" name="image" value="' . $_SESSION["image"] . '">
                                                    <input type="" name="vali" value="12">
                                                    <input type="" name="acc_type" value="pizza and burger">
                                                    <input type="" name="amount" value="499">
                                                    <button class="fcard_btn px-4">Buy Now</button>
                                                </form>';
                                        }
