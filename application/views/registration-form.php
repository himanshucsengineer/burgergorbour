        ...
        <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
            <div class="card card-signin my-5">
                <div class="card-body">
                    ...
                    <form action="<?php echo base_url(); ?>frontend/register/pay" method="post" class="form-signin">
          ...
          <label for="subject">Amount <span style="color: #FF0000">*</span></label>
                        <div class="form-label-group">
                            <input type="text" id="amount" name="amount" value="10"  class="form-control" placeholder="Amount" required>
                        </div><br/>
                       <br/>
